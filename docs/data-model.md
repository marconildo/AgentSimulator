...
Keys today: `ollama_base_url` (074), `openai_api_key` (078),
`embedding_provider` / `embedding_model` / `embedding_signature` (075).
**Values may be secrets** (e.g. `openai_api_key`): read endpoints **mask** them
